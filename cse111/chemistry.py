...
def main():
    ...
    molecular_formula_of_sample = input(
        "Enter the molecular formula of the sample: ")

    # Get the mass of a chemical sample in grams from the user.
    mass_in_grams_of_sample = input("Enter the mass in grams of the sample: ")
    ...
    # ................................................................................................
    parse_formula(molecular_formula_of_sample, table)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = compute_molar_mass(mass_in_grams_of_sample, table)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for i in symbol_quantity_list:
        ...
        atomic_mass_by_quantity = mass * quantity
        total_molar_mass += atomic_mass_by_quantity
